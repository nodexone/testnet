...
echo -e "Chain Name: \e[1m\e[32m$REBUS_CHAIN_ID\e[0m"
...
wget -qO $HOME/.rebusd/config/genesis.json "https://raw.githubusercontent.com/rebus-Labs/testnet/main/poolparty/genesis.json"

# set peers and seeds
SEEDS="baee9ccc2496c2e3bebd54d369c3b788f9473be9@seedv1.poolparty.rebusdnet.co:26656"
