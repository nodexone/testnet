...
```
wget -O masa.sh https://raw.githubusercontent.com/nodexcapital/testnet/main/masa/masa.sh && chmod +x masa.sh && ./masa.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodexcapital/testnet/blob/main/masa/manual_install.md) if you better prefer setting up node manually
