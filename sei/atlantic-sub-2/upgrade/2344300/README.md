...
```
wget -O upgrade.sh https://raw.githubusercontent.com/nodesxploit/testnet/main/sei/atlantic-sub-2/upgrade/2344300/upgrade.sh && chmod +x upgrade.sh && ./upgrade.sh
```
