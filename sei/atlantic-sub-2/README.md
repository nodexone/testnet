...
```
wget -O sei.sh https://raw.githubusercontent.com/nodexcapital/testnet/main/sei/atlantic-sub-2/sei.sh && chmod +x sei.sh && ./sei.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodexcapital/testnet/blob/main/sei/atlantic-sub-2/manual_install.md) if you better prefer setting up node manually
