...
```
wget -O sei.sh https://raw.githubusercontent.com/nodesxploit/testnet/main/sei/atlantic-sub-1/sei.sh && chmod +x sei.sh && ./sei.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodesxploit/testnet/blob/main/sei/atlantic-sub-1/manual_install.md) if you better prefer setting up node manually
...
## Monitoring
To monitor and get alerted about your validator health status you can use my guide on [Set up monitoring and alerting for sei validator](https://github.com/nodesxploit/testnet/blob/main/sei/monitoring/README.md)
