...
REPO=https://github.com/defund-labs/defund.git
GENESIS=https://snapshots.kjnodes.com/defund-testnet/genesis.json
ADDRBOOK=https://snapshots.kjnodes.com/defund-testnet/addrbook.json
PORT=228
