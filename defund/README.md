...
> To migrate your validator to another machine read [Migrate your validator to another machine](https://github.com/nodesxploit/testnet/blob/main/defund/migrate_validator.md)
...
```
wget -O defund.sh https://raw.githubusercontent.com/nodesxploit/testnet/main/defund/defund.sh && chmod +x defund.sh && ./defund.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodesxploit/testnet/blob/main/defund/manual_install.md) if you better prefer setting up node manually
...
```
wget -O synctime.py https://raw.githubusercontent.com/nodesxploit/testnet/main/defund/tools/synctime.py && python3 ./synctime.py
```
