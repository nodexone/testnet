...
```
wget -O tidechain.sh https://raw.githubusercontent.com/nodesxploit/testnet/main/tidechain/tidechain.sh && chmod +x tidechain.sh && ./tidechain.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodesxploit/testnet/blob/main/tidechain/manual_install.md) if you better prefer setting up node manually
