...
> To migrate your validator to another machine read [Migrate your validator to another machine](https://github.com/nodesxploit/testnet/blob/main/deweb/migrate_validator.md)
...
```
wget -O deweb.sh https://raw.githubusercontent.com/nodesxploit/testnet/main/deweb/deweb.sh && chmod +x deweb.sh && ./deweb.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodesxploit/testnet/blob/main/deweb/manual_install.md) if you better prefer setting up node manually
...
```
wget -O synctime.py https://raw.githubusercontent.com/nodesxploit/testnet/main/deweb/tools/synctime.py && python3 ./synctime.py
```
