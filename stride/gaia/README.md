...
```
wget -O gaia.sh https://raw.githubusercontent.com/nodesxploit/testnet/main/stride/gaia/gaia.sh && chmod +x gaia.sh && ./gaia.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodesxploit/testnet/blob/main/stride/gaia/manual_install.md) if you better prefer setting up node manually
...
```
wget -O synctime.py https://raw.githubusercontent.com/nodesxploit/testnet/main/gaia/tools/synctime.py && python3 ./synctime.py
```
