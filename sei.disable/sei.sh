...
echo " ██║ ╚████║╚██████╔╝██████╔╝███████╗██╔╝ ██╗    ╚██████╗██║  ██║██║     ██║   ██║   ██║  ██║███████╗";
echo " ╚═╝  ╚═══╝ ╚═════╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝     ╚═════╝╚═╝  ╚═╝╚═╝     ╚═╝   ╚═╝   ╚═╝  ╚═╝╚══════╝";
echo ">>> Cosmovisor Automatic Installer for Sei Network | Chain ID : atlantic-1 <<<";
echo -e "\e[0m"
...
GENESIS=https://snapshots.kjnodes.com/sei-testnet/genesis.json
ADDRBOOK=https://snapshots.kjnodes.com/sei-testnet/addrbook.json
PORT=30
...
# Set peers and seeds
PEERS=""
SEEDS="3f472746f46493309650e5a033076689996c8881@sei-testnet.rpc.kjnodes.com:12659"
...
curl -L https://snapshots.kjnodes.com/sei-testnet/snapshot_latest.tar.lz4 | tar -Ilz4 -xf - -C $HOME/$FOLDER
