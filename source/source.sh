...
echo " ██║ ╚████║╚██████╔╝██████╔╝███████╗██╔╝ ██╗    ╚██████╗██║  ██║██║     ██║   ██║   ██║  ██║███████╗";
echo " ╚═╝  ╚═══╝ ╚═════╝ ╚═════╝ ╚══════╝╚═╝  ╚═╝     ╚═════╝╚═╝  ╚═╝╚═╝     ╚═╝   ╚═╝   ╚═╝  ╚═╝╚══════╝";
echo ">>> Cosmovisor Automatic Installer for Source Protocol | Chain ID : sourcechain-testnet <<<";
echo -e "\e[0m"
...
FOLDER=.source
VERSION=e06b810e842e57ec8f5432c9cdd57883a69b3cee
DENOM=usource
COSMOVISOR=cosmovisor
REPO=https://github.com/Source-Protocol-Cosmos/source.git
GENESIS=https://snapshots.kjnodes.com/source-testnet/genesis.json
ADDRBOOK=https://snapshots.kjnodes.com/source-testnet/addrbook.json
PORT=46
...
curl -L https://snapshots.kjnodes.com/source-testnet/snapshot_latest.tar.lz4 | tar -Ilz4 -xf - -C $HOME/$FOLDER
