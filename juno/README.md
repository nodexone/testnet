...
> To migrate your validator to another machine read [Migrate your validator to another machine](https://github.com/nodexcapital/testnet/blob/main/juno/migrate_validator.md)
...
```
wget -O juno.sh https://raw.githubusercontent.com/nodexcapital/testnet/main/juno/juno.sh && chmod +x juno.sh && ./juno.sh
```

### Option 2 (manual)
You can follow [manual guide](https://github.com/nodexcapital/testnet/blob/main/juno/manual_install.md) if you better prefer setting up node manually
...
```
wget -O synctime.py https://raw.githubusercontent.com/nodexcapital/testnet/main/juno/tools/synctime.py && python3 ./synctime.py
```
